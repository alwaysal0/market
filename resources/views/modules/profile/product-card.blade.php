<div class="product-card">
    ...
    <div class="product-card__actions">
        <form method="POST" class="product-card__delete" action="{{ route('profile.your-products.delete', ['product' => $product]) }}">
            @csrf
            @method('DELETE')
            <button type="submit">
        ...
        <a href="{{ route("profile.your-products.show", ['product' => $product]) }}" class="product-card__edit">
