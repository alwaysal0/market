...
@if($change_password_access === true)
    ...
    <form method="POST" action="/profile/edit-profile/change-password/access-true">
        @csrf
...
@else
    ...
    <form method="POST" action="/profile/edit-profile/change-password/verification-email">
        @csrf
        <div class="change-password-cont">
